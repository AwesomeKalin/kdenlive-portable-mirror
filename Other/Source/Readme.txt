DEVELOPER: Replace occurrences of KdenlivePortable in this file with the
...
user in an INI file next to KdenlivePortable.exe called KdenlivePortable.ini.
...
copy AppNamePortable.ini from this directory to KdenlivePortable.ini next to
KdenlivePortable.exe. The options in the INI file are as follows:
